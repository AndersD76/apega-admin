  ...
  const ONBOARDING_SLIDES = [
    {
      ...
      subtitle: 'A primeira plataforma de moda circular do Brasil',
    ...
    },
    {
      ...
      subtitle: 'Avaliamos suas peças automaticamente e sugerimos o melhor preço',
      highlight: 'SIMPLES',
    ...
    },
    {
      ...
      iconColor: '#E91E63',
      title: '0% de comissão',
      subtitle: 'Para as primeiras 50 vendedoras. Para sempre.',
      highlight: 'EXCLUSIVO',
    ...
    },
    {
      ...
      subtitle: '5 primeiras vagas ganham Premium por 1 ano!',
      highlight: 'LIMITADO',
